                  ...
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:15px;padding-right:30px;padding-left:30px;text-align:left;">
                      <center>
                        ...
                        <p class="description center" style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;Margin-bottom:10px;margin-left: auto; margin-right: auto;"><span style="color: rgb(161, 168, 173); font-family: Muli, &quot;Arial Narrow&quot;, Arial; font-size: 15px; text-align: center; background-color: rgb(255, 255, 255);"></span></span></p>
                        <span class="sg-image" >
	                        <a href="<?php echo base_url();?>index.php/general/reset_password/admin" target="_blank" style="font-family: 'Graphik-Medium', Helvetica, Arial, sans-serif !important;; font-size:13px; padding:8px; background-color:#236ea6;letter-spacing: 3px; text-decoration:none; display:inline-block;">
	                        	<span style="font-family: 'Graphik-Medium', Helvetica, Arial, sans-serif !important;; font-size:13px; line-height:22px; color:#fff; text-decoration:none;">RESET NOW</span>
	                        </a>
                        </span>
                      </center>
                    </td>
