        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <h2>Signin</h2>
                    <p>Enter your email address and password to access Admin Dashboard.</p>
                    ...
                    <form action="<?php echo base_url();?>index.php/general/login" method="POST">
                        ...
                        <div class="form-group">
                            <label>Password</label><label style="float:right;"><a href="<?php echo base_url();?>index.php/general/forget_password">Forget Passwsord?</a></label>
