...
$followclassid=$_POST['followclass_id'];
$class_date= $_POST['class_date'];

// $sql = "INSERT INTO booking_follow_class (student_id, followclassid, date)
// VALUES ('$student_email','$followclassid','$date')";
$sql = "INSERT INTO booking_follow_class (follow_class_id, date) VALUES ('$followclassid','$class_date')";
